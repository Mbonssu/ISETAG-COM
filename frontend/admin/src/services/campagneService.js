...
export const campagneService = {
  ...
  /**
   * PUT /campagne_api/ISETAG_COM.participations/<id>/ -> modifier une participation
   */
  updateParticipation: (idParticipation, data) => {
    console.log('📝 PUT update participation:', idParticipation, data);
    return api.put(`/campagne_api/ISETAG_COM.participations/${idParticipation}/`, { idParticipation, ...data });
  },

  /**
   * DELETE /campagne_api/ISETAG_COM.participations/<id>/ -> retirer un agent de la sortie
   */
  deleteParticipation: (idParticipation) => {
    console.log('🗑️ DELETE participation:', idParticipation);
