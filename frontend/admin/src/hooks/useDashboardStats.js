...
// //
// // ⚠️ CORRIGÉ : l'ancienne version importait "./apiClient" et
// // "./statsService", deux fichiers qui n'existaient nulle part dans le
// // projet -> le Dashboard plantait à 100% avant même de s'afficher.
// //
// // Version réécrite en s'appuyant directement sur les vrais services déjà
// // corrigés (prospectService, relanceService, suiviService, ficheService,
// // campagneService), avec les vrais noms de champs du backend
// // (ISETAG_COM_API.yaml).
