          ...
          {showNotifications && (
            <div className="notifications-dropdown">
              <div className="notif-header">
                ...
                <button className="mark-all-read" onClick={markAllAsRead}>Tout marquer comme lu</button>
              </div>
              <div className="notif-list">
                {notifications.length === 0 ? (
                  <div className="notif-item" style={{ cursor: 'default' }}>
                    <div className="notif-content">
                      <div className="notif-message">Aucune notification pour le moment</div>
                    </div>
                  </div>
                ) : (
                  notifications.map(notif => (
                    ...
                    >
                      ...
                      <div className="notif-content">
                        ...
                        <div className="notif-time">{formatRelativeTime(notif.time)}</div>
                      </div>
                    </div>
                  ))
                )}
